    ...
    render() {
        return (
            <div className="container" onKeyDown={this.handleKeyDown}>
                <div className="row">
                    <div className="offset-md-4 col-lg-6 mt-5">
                        <form id="msform">
                            ...
                            <div style={this.props.showNavigation ? {} : {display: 'none'}}>
                                ...
                                <input style={this.state.showPreviousBtn ? {} : {display: 'none'}}
                                       onClick={this.previous} type="button" name="previous" className="previous action-button btn-p" value="Previous" />
